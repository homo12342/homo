...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/homo)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/homo
```

A live public deployment of this template is available at [https://homo.templates.workers.dev](https://homo.templates.workers.dev)
